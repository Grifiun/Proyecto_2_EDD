 ...
 * @author 50234
 */
@WebServlet(name = "ControladorIngresoUsuario", urlPatterns = {"/ControladorIngresoUsuario"})
public class ControladorIngresoUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(instancias.InstanciaEstructuraUsuarios.buscarUsuario(id) != null){           
            ...
            Usuario usr = instancias.InstanciaEstructuraUsuarios.buscarUsuario(id);
            mensaje = "Usuario " + usr.getNombre() + " creado";
        }else{
